    ...
    Loadchart() {
      ...
      axios
        ...
        .then(response => {
          ...
          var lastTarget = seft.targets;
          if (response.data.Status == false) {
            let i = 0;
            for (i = 0; i < seft.chart.data.datasets[1].data.length; i++) {
              if (parseFloat(seft.chart.data.datasets[1].data[i]) > parseFloat(lastTarget[i])) {
                seft.pointBackgroundColors.push("green");
                seft.chart.data.datasets[1].borderColor = "#e7263b";
              } else {
            ...
            for (i = 0; i < seft.chart.data.datasets[1].data.length; i++) {
              if (parseFloat(seft.chart.data.datasets[1].data[i]) > parseFloat(lastTarget[i])) {
                ...
                seft.pointBackgroundColors.push("green");
                seft.chart.data.datasets[1].borderColor = "green";
              } else {
                seft.pointBackgroundColors.push("red");
                seft.chart.data.datasets[1].borderColor = "green";
              }
