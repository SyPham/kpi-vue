...
export default {
  data() {
    return {
      ...
      excelName: "",
      serveOption: "http://10.4.5.174:91/ChartPeriod/SaveFile",
      myFiles: [],
      file: "",
      filename: "",
      server: {
        process: "http://10.4.5.174:91/ChartPeriod/SaveFile",
        revert: null
      },
      userIDactionplan: 0,
      rootcause: "",
  ...
  methods: {
    ...
    DownloadExcel(data) {
      ...
      let url = `http://10.4.5.174:91/ChartPeriod/DownloadExcelActionPlan/${data.Name}`;
      this.$vs.loading();
      this.$http({
        method: "get",
        url: url,
