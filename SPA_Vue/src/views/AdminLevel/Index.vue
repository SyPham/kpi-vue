        ...
        <div class="col-md-12">
          <ejs-treegrid
            ...
            <e-columns>
              ...
              <e-column field="title" editType="stringedit" width="800" headerText="OC Name" :template="OCTemplate" edit="editparams" :disableHtmlEncode="false"></e-column>
              <e-column field="code" editType="stringedit" headerText="Code" :template="CodeTemplate" edit="editparams" :disableHtmlEncode="false"></e-column>
            </e-columns>
        </ejs-treegrid>
    ...
    delete(id){
      this.$swal({
        ...
        .then(res=>{
          ...
          // this.$swal('Deleted', 'OC has been deleted', 'success')
          this.GetOcs()
        })
       } else {
