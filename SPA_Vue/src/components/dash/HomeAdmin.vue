        ...
        <div class="col-12 col-sm-6 col-md-3">
          <a href="#/KpiKind/" style="text-decoration: none;">
            <div class="info-box demo">
              ...
              <div class="info-box-content"><span  class="info-box-text">(2)KPI Kind</span> <span class="info-box-number " style="color: rgb(255, 255, 255);"></span></div>
            </div>
          </a>
        </div>
        <div  class="col-12 col-sm-6 col-md-3">
          <a  href="#/AdminKPI/" style="text-decoration: none;">
            <div class="info-box demo">
              ...
              <div class="info-box-content"><span  class="info-box-text">(3) KPI</span> <span  class="info-box-number " style="color: rgb(255, 255, 255);"></span></div>
            </div>
          </a>
        </div>
        <div  class="col-12 col-sm-6 col-md-3">
          <a  href="#/AdminCategory/" style="text-decoration: none;">
            <div class="info-box demo">
              ...
              <div class="info-box-content"><span  class="info-box-text">(4) Category</span> <span  class="info-box-number " style="color: rgb(255, 255, 255);"></span></div>
            </div>
          </a>
        </div>
        <div  class="col-12 col-sm-6 col-md-3">
          <a  href="#/OCCategories/" style="text-decoration: none;">
            <div class="info-box demo">
              ...
              <div class="info-box-content"><span  class="info-box-text">(5) OC Category</span> <span  class="info-box-number " style="color: rgb(255, 255, 255);"></span></div>
            </div>
          </a>
        </div>
        <div  class="col-12 col-sm-6 col-md-3">
          <a href="#/AdminOC/" style="text-decoration: none;">
            <div class="info-box demo">
              ...
              <div class="info-box-content"><span  class="info-box-text">(6) OC KPI</span> <span  class="info-box-number " style="color: rgb(255, 255, 255);"></span></div>
            </div>
          </a>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <a href="#/CategoryKPILevelAdmin/" style="text-decoration: none;">
            <div class="info-box demo">
              ...
              <div class="info-box-content"><span  class="info-box-text">(7) OC Category KPI</span> <span  class="info-box-number " style="color: rgb(255, 255, 255);"></span></div>
            </div>
          </a>
        </div>
        <div  class="col-12 col-sm-6 col-md-3">
          <a href="#/AdminUser/" style="text-decoration: none;">
            <div class="info-box demo">
              ...
              <div class="info-box-content"><span  class="info-box-text">(8) User</span> <span  class="info-box-number " style="color: rgb(255, 255, 255);"></span></div>
            </div>
          </a>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <a href="#/AddUserToLevel/" style="text-decoration: none;">
            <div class="info-box demo">
              ...
              <div class="info-box-content"><span  class="info-box-text">(9) OC User</span> <span  class="info-box-number " style="color: rgb(255, 255, 255);"></span></div>
            </div>
          </a>
        </div>
