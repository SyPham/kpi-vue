  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div v-if="role == 1" class="row">
        ...
        <div v-for="(item,key,index) in menuAdmin" :key="index" class="col-12 col-sm-6 col-md-3">
      ...
      <div v-else>
        ...
        <div v-if="tabsUser" class="row">
          ...
          <div v-for="(item,key,index) in menuUser" :key="index" class="col-12 col-sm-6 col-md-3">
            <a :href="'#' + item.Link" style="text-decoration:none">
              <div class="info-box demo">
                <span :class="'info-box-icon' + ' ' + item.BackgroudColor+ ' ' + 'elevation-1'"
                  ><i :class="item.FontAwesome"></i
