          ...
          <div class="card">
            ...
            <div v-if="isHide" class="card-body table-responsive p-0">
              ...
              <ejs-grid  ref="grid" :searchSettings="searchSettings" :actionComplete="actionComplete" :rowSelected="rowSelected2"  :toolbar='toolbarOptions' :dataSource='data2' allowPaging='true' :pageSettings='pageSettings2' >
                <e-columns>
                  <e-column field='ID' headerText='#' width='50' textAlign='Left' isPrimaryKey='true'></e-column>
                  <e-column :template="addUserTemplate" width='60'></e-column>
                  <e-column field='Username' headerText='User Name' width='100' textAlign='Left' ></e-column>
                  <e-column field='FullName' headerText='Display Name' width='150' textAlign='Center' ></e-column>
                  <e-column :template="OCNameTemplate" field='OCName' headerText='OC Name' width='130' textAlign='Center' ></e-column>
