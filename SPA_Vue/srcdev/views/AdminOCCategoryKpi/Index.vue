        ...
        <div class="card">
          ...
          <div v-if="isHide" class="card-body table-responsive p-0">
            <ejs-grid  ref="grid" :searchSettings="searchSettings" :actionComplete="actionComplete" :rowSelected="rowSelected2"  :toolbar='toolbarOptions' :dataSource='data2' allowPaging='true' :pageSettings='pageSettings2' >
              <e-columns>
                <e-column field='ID' :template="SttTemplateCate"  headerText='#' width='80' textAlign='Left' isPrimaryKey='true'></e-column>
                <e-column field='Name' headerText='Category Name' width='150' textAlign='Left' ></e-column>
                <e-column field='Kind' headerText='Kind' width='150' textAlign='Left' ></e-column>
        ...
        <div v-if="ocHide" class="card">
          ...
          <div class="card-body table-responsive p-0">
              <ejs-grid  ref="grid" :searchSettings="searchSettings" :actionComplete="actionComplete" :rowSelected="rowSelected3"  :toolbar='toolbarOptions' :dataSource='data3' allowPaging='true' :pageSettings='pageSettings2' >
                <e-columns>
                  <e-column field='ID' headerText='#' :template="SttTemplate"  width='30' textAlign='Left' isPrimaryKey='true'></e-column>
...
export default {
  ...
  data() {
    return {
      ...
      SttTemplateCate: function() {
        return {
          template: Vue.component("SttTemplateCate", {
            template: `
              <span>{{NO(data)}}</span>
            `,
            data: function() {
      ...
      modifyTemplate: function() {
        return {
          template: Vue.component("modifyTemplate", {
            template: `
              <button v-if="data.Checked == true" @click="modify(data)" class="btn-sm btn-info  ">
