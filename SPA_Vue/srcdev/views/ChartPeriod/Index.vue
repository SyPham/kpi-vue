...
export default {
  data() {
    return {
      ...
      excelName: "",
      serveOption: "http://10.4.5.132:991/ChartPeriod/SaveFile",
      myFiles: [],
      file: "",
      filename: "",
      server: {
        process: "http://10.4.5.132:991/ChartPeriod/SaveFile",
        revert: null
      },
      userIDactionplan: 0,
      rootcause: "",
  ...
  methods: {
    clearSearch(period) {
      ...
      // if(period == 'M') {
      //   this.$router.push(`/ChartPeriod/${this.kpilevelcode}/${this.$route.params.catid}/${this.period}/${this.$route.params.year}/1/12`)
      //   this.Loadchart();
      // }
    },
    onChangePoint() {},
    ...
    DownloadExcel(data) {
      ...
      let url = `http://10.4.5.132:991/ChartPeriod/DownloadExcelActionPlan/${data.Name}`;
      this.$vs.loading();
      this.$http({
        method: "get",
        url: url,
    ...
    handleFileProcess() {
      ...
      // this.file = this.$refs.pond.getFiles()[0].file;
      this.file = arr ;
      // this.filename = this.$refs.pond.getFiles()[0].file.name;
    },
    handleUndo() {
    ...
    closemodalAction() {
      //console.log('destroy Actionplan')
      this.$router.push(
