          ...
          <div class="card">
                ...
                <div v-if="isHide" class="card-body table-responsive p-0">
                    <ejs-grid  ref="grid" :dataSourceChanged="dataSourceChanged" :searchSettings="searchSettings2" :rowSelected="rowSelected2"  :toolbar='toolbarOptions' :dataSource='data2' allowPaging='true' :pageSettings='pageSettings2' >
                        <e-columns>
                            <e-column field='ID' :template="SttTemplate" headerText='#' width='80' textAlign='Left' isPrimaryKey='true'></e-column>
                            <e-column width='60' :template="CheckboxTemplate">
                            </e-column>
...
export default {
  ...
  methods: {
    ...
    getOc(){
      ...
      // axios.get('OCCategories/GetListTree').then(res=>{
      //   this.data = res.data
      // })
    },
    getCategoryByOC(){
