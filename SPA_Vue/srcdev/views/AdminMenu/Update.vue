        ...
        <form @submit.prevent="update" role="form">
          <div class="card-body">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" v-model="Link" class="form-control" placeholder="Enter Code" />
            </div>
            <div class="form-group col-md-6">
              <label for="exampleInputEmail1">FontAwesome</label>
              <input type="text" v-model="FontAwesome" class="form-control" placeholder="Enter Level" />
            </div>
            <div class="form-group col-md-6">
              <label for="exampleInputEmail1">BackgroudColor</label>
              <input type="text" v-model="BackgroudColor" class="form-control" placeholder="Enter Level" />
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input  type="number" v-model="Position" class="form-control" placeholder="Enter Level" />
            </div>
          </div>
          <!-- /.card-body -->
