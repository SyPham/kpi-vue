...
//Cate_KIND
const Cate_KIND = () => import(/* webpackChunkName: "AdminCateKind" */ './views/CateKind/Index')
const UpdateCate_KIND = () => import(/* webpackChunkName: "UpdateCateKind" */ './views/CateKind/Update')
const CreateCate_KIND = () => import(/* webpackChunkName: "CreateCateKind" */ './views/CateKind/Create')
          ...
          children: [
            {
              path: "",
              component: Cate_KIND ,
              meta: { requiresAuth: true, breadcrumb: 'Category Kind'},
            },
            {
              path: "create",
              component: {
              ...
              meta: { requiresAuth: true, breadcrumb: 'Category Kind' , url: "/CateKind"},
              children: [
                {
                  path: "",
                  component: CreateCate_KIND ,
                  meta:{ requiresAuth: true , breadcrumb: 'Create Cate KIND'},
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  component: UpdateCate_KIND ,
                  meta:{ requiresAuth: true , breadcrumb: 'Update Cate KIND'},
                }
              ]
